...
# d_gb_test
srun python scaling_tests.py -o ../output/parametric_study/polycrystal/d_gb_test -i ../inputs/config.yaml --test_type d_gb_test --time 2:00:00

# sigma1_test
srun python scaling_tests.py -o ../output/parametric_study/polycrystal/sigma1_test -i ../inputs/config.yaml --test_type sigma1_test --time 1:00:00
...
# ic_test
srun python scaling_tests.py -o ../output/parametric_study/polycrystal/ic_test -i ../inputs/config.yaml --test_type ic_test --time 1:00:00
