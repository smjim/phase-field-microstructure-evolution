...
!! DO THIS WITH MYID==0
      ...
      if (myid == 0) then
        ...
        !open(96, file=trim(output_dir) // '/precipitate_fraction.dat', status='unknown')
        !write(96,'(A)') "# step, precipitate_voxels, &
      ...
      do step_i = my_start_step, my_end_step 
            ...
            do kk = 1, dims(2)
              ...
              do i = 1, Nx 
                ...
                !if (phi_above_threshold > 1) boundary_voxels = boundary_voxels + 1 
