      ...
      open(10, file='var_dist', status='unknown')
      ...
      open(21, file='phi_sq.vtk', status='unknown')
      open(22, file='con.vtk', status='unknown')
      open(23, file='var_num.vtk', status='unknown')
      open(24, file='phi_3.vtk', status='unknown')
