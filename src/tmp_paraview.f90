      ...
      real *8, dimension(:), allocatable ::  phi_1_gl, phi_2_gl, phi_3_gl
      real *8, dimension(:), allocatable ::  precipitate_gl, grad_precipitate_gl
      ...
      character(len=256) :: infile, outfile_phi_sq, outfile_con, outfile_var_num, outfile_precipitate, outfile_grad_precipitate
      character(len=256) :: outfile_phi_1, outfile_phi_2, outfile_phi_3
      ...
      do step_i = 1, num_steps 
            ...
            allocate (phi_1_gl(1:Nxyz))
            allocate (phi_2_gl(1:Nxyz))
            allocate (phi_3_gl(1:Nxyz))
            allocate (precipitate_gl(1:Nxyz))
            allocate (grad_precipitate_gl(1:Nxyz))
            ...
            outfile_phi_1 = trim(output_dir) // '/phi_1_' // trim(adjustl(step_string)) // '.vtk'
            outfile_phi_2 = trim(output_dir) // '/phi_2_' // trim(adjustl(step_string)) // '.vtk'
            outfile_phi_3 = trim(output_dir) // '/phi_3_' // trim(adjustl(step_string)) // '.vtk'
            outfile_precipitate = trim(output_dir) // '/precipitate_' // trim(adjustl(step_string)) // '.vtk'
            outfile_grad_precipitate = trim(output_dir) // '/grad_precipitate_' // trim(adjustl(step_string)) // '.vtk'
            ...
            open(24, file=trim(outfile_phi_1), status='unknown')
            open(25, file=trim(outfile_phi_2), status='unknown')
            open(26, file=trim(outfile_phi_3), status='unknown')
            open(27, file=trim(outfile_precipitate), status='unknown')
            open(28, file=trim(outfile_grad_precipitate), status='unknown')
